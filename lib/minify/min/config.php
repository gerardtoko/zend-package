 ...
 */
$min_documentRoot = substr(__FILE__, 0, -26);
...
$directory_cache = $min_documentRoot . '/var/cache/minify';

if (!is_dir($directory_cache)) {
    mkdir($directory_cache, 0775, true);
    chmod($directory_cache, 0775);
}

$min_cachePath = $directory_cache;
